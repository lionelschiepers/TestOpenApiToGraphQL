...
async function main() {
    ...
    let oas1 = await getData('https://belgianrail-station.azurewebsites.net/openapi.json');
    let oas2 = await getData('https://belgianrail-reservation.azurewebsites.net/openapi.json');
